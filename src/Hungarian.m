%> @file  Hungarian.m
%> @brief Function that matches two sets of vectors
%======================================================================
%> @brief A function for finding a minimum edge weight matching given a MxN Edge
...
%> External code, not supported by CBICA
%> @b Link: 
%> http://www.mathworks.com/matlabcentral/fileexchange/11609-hungarian-algorithm/content/ungarian.m
%> 
%> @b Contact: 
%> Alex Melin 30 June 2006
%======================================================================
